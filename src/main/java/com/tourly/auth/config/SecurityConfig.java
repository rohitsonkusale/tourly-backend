    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/trips/search/filter").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/trips/{tripId}").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/reviews/host/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/reviews/planner/**").permitAll()
