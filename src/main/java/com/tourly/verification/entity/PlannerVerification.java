...
public class PlannerVerification {
    ...
    @Column(name = "planner_verification_id")
    private Long id;
    ...
    @PrePersist
    protected void onCreate() { LocalDateTime now = LocalDateTime.now(); createdAt = now; updatedAt = now; if (verificationStatus == null) verificationStatus = VerificationStatus.PENDING; }
